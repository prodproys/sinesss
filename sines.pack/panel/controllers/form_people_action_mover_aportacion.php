...
/**
**** 
* Archivo: form_people_action_mover_aportacion.php
* Author: Sinesss
* Tipo: Controlador
* Lenguaje: PHP
* Descripción:  Este archivo es el controller backend del formulario de mover aportación regular
**** 
*/
...
$title="Mover a aportación regular";
