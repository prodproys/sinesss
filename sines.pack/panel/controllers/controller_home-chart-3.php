...
/**
**** 
* Archivo: controller_home-chart-3.php
* Author: Sinesss
* Tipo: Controlador
* Lenguaje: PHP
* Descripción:  Este archivo provee los datos backend que usa la grafica "ingreso fondo caee" de la pagina "dashboard"
**** 
*/
...
foreach($income_types as $type=>$name){
    ...
    $series_sql[$type]=opciones(
        [
            'secondaryshares.month as id',
            'sum(secondaryshares.amount) as nombre'
        ],
        "people",
        "
        left join secondaryshares on people.id=secondaryshares.id_persona
