...
/**
**** 
* Archivo: form_people_action_agregar_aportacion.php
* Author: Sinesss
* Tipo: Controlador
* Lenguaje: PHP
* Descripción:  Este archivo es el controller backend del formulario de agremiar agregar aportación regular
**** 
*/
...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    */
        ...
        if(sizeof($_POST['shares'])>0){
            ...
            $operation=insert([
                ...
                'share_type'=>'PrimaryShareOperation',
                'id_persona'=>$_GET['id_person'],
    ...
    */
    ...
    update_evolution($_POST['shares'],[0],[$persona['id_settlement']],[$persona['id_group']]);
    ...
    echo json_encode([
        ...
        'eval'=>"document.querySelector('.nav-link.link-primaryshares').click();",
        'more'=>$more
    ]);
...
$title="Registro de aportaciones regulares";
...
if($_GET['mode']=='edit' and $_GET['id']!=''){
    ...
    $title="Editar Aportación Regular ".fecha_formato($document['month'],'4b');
...
if($_GET['mode']=='delete' and $_GET['id']!=''){
    ...
    $alert=[
        'title'=>'Eliminar',
        'text'=>'¿Desea eliminar aportación regular?',
        'class'=>'alert-danger',
    ];

    $title="Eliminar Aportación Regular ".fecha_formato($document['month'],'4b');
...
if($_GET['mode']=='revision' and $_GET['id']!=''){
    ...
    $title="Revisión Aportación Regular ".fecha_formato($document['month'],'4b');
